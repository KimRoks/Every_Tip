...
final class SavedTipViewController: BaseViewController {
...
extension SavedTipViewController: View {
    func bind(reactor: SavedTipReactor) {
        bindInput(reactor: reactor)
        bindOutput(reactor: reactor)
    }
    
    func bindInput(reactor: SavedTipReactor) {
        rx.viewDidLoad
    ...
    func bindOutput(reactor: SavedTipReactor) {
        reactor.state
            .map { $0.tips }
